...
public class AdapterMyProperty extends
        RecyclerView.Adapter<AdapterMyProperty.ViewHolder> {
    Context context;

    private List<BoPropertyMy> allItems;

    public AdapterMyProperty(List<BoPropertyMy> allItems) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View v = LayoutInflater.from(context).inflate(R.layout.row_property,
                parent, false);
